...
namespace ImGui
{
    ...
    IMGUI_API bool          CollapsingHeaderEx(const char* str_id, const char* label, ImGuiTreeNodeFlags flags = 0);  // if returning 'true' the header is open. doesn't indent nor push on ID stack. user doesn't have to call TreePop().
